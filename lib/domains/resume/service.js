...
export function requestResumeGetNode (args = isRequire()) {
  return new Promise(async (resolve, reject) => {
    ...
    if (!validateResult) {
      ...
      await Resume.requestResumeGetNode(Object.assign({
        resumeVersion: '1',
        resumeLanguage: 1,
      }, args)).then((res) => {
        resolve(res)
...
export function requestResumeSetNode (args = isRequire()) {
  return new Promise(async (resolve, reject) => {
    ...
    if (!validateResult) {
      ...
      await Resume.requestResumeSetNode(Object.assign({
        resumeVersion: '1',
        resumeLanguage: 1,
      }, args)).then((res) => {
        resolve(res)
...
export function requestResumeDeleteNode (args = isRequire()) {
  return new Promise(async (resolve, reject) => {
    ...
    if (!validateResult) {
      ...
      await Resume.requestResumeDeleteNode(Object.assign({
        resumeVersion: '1',
        resumeLanguage: 1,
      }, args)).then((res) => {
        resolve(res)
...
export function requestResumePreview (args = isRequire()) {
  return new Promise(async (resolve, reject) => {
    ...
    if (!validateResult) {
      ...
      await Resume.requestResumePreview(Object.assign({
        resumeVersion: '1',
        resumeLanguage: 1,
      }, args)).then((res) => {
        resolve(res)
 ...
 * @param {*} args 
 *  {
 *    resumeType: 0, // 简历类型，0-社招简历，1-学生简历
 *    resumeLanguage: 1,  // 简历语言：1-中文，2-英文 ，3-中英文
 *  }
 * @return Promise
 */
export function requestResumeCreate (args = isRequire()) {
  return new Promise(async (resolve, reject) => {
    if (String(args.resumeType) === 'undefined' ) {
      reject(new Error('简历类型不能为空，类型为Number'))
    } else {
      await Resume.requestResumeCreate(Object.assign({
        resumeLanguage: 1,
      }, args)).then((res) => {
        resolve(res)
      }).catch(err => {
...
export function requestResumeDelete (args = isRequire()) {
  return new Promise(async (resolve, reject) => {
    ...
    if (!validateResult) {
      ...
      await Resume.requestResumeDelete(Object.assign({
        resumeVersion: '1',
        resumeLanguage: 1,
      }, args)).then((res) => {
        resolve(res)
...
export function requestResumeOperate (args = isRequire()) {
  return new Promise(async (resolve, reject) => {
    ...
    if (!validateResult) {
      ...
      await Resume.requestResumeOperate(Object.assign({
        resumeVersion: '1',
        resumeLanguage: 1,
      }, args)).then((res) => {
        resolve(res)
...
export function requestResumeModifyName (args = isRequire()) {
  return new Promise(async (resolve, reject) => {
    ...
    if (!validateResult) {
      ...
      await Resume.requestResumeModifyName(Object.assign({
        resumeVersion: '1',
        resumeLanguage: 1,
      }, args)).then((res) => {
        resolve(res)
...
export function requestResumeStatus (args = isRequire()) {
  return new Promise(async (resolve, reject) => {
    ...
    if (!validateResult) {
      ...
      await Resume.requestResumeStatus(Object.assign({
        resumeVersion: '1',
        resumeLanguage: 1,
      }, args)).then((res) => {
        resolve(res)
